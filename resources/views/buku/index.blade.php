...
<!-- responsiv parahhh -->
<div class="d-flex flex-column flex-md-row justify-content-start justify-content-md-between align-items-start align-items-md-center gap-2 mb-3">
    <!-- SHOW -->
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('buku.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="button" class="btn btn-secondary btn-aksi" data-dismiss="modal"
                            style="width:47%">
                        Batal
                    </button>
                </div>
